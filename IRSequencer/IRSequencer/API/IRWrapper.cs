    ...
    public class IRWrapper
    {
        ...
        public class IRAPI
        {
            ...
            public class IRServo
            {
                ...
                private FieldInfo PositionField;
                public float Position
                {
                    get { return (float)PositionField.GetValue(actualServo); }
                    set { PositionField.SetValue(actualServo, value); }
                }

                private MethodInfo MoveToMethod;
                internal void MoveTo(float position, float speedMultiplier)
                {
                    MoveToMethod.Invoke(actualServo, new System.Object[] { });
                }

                private MethodInfo StopMethod;
                internal void Stop()
                {
                    StopMethod.Invoke(actualServo, new System.Object[] { });
                }
            }
